...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('triage_case_id', sa.String(36), sa.ForeignKey('triage_cases.id'), nullable=True, index=True),
    ...
    op.create_table(
        ...
        sa.Column('previous_version_id', sa.String(36), sa.ForeignKey('questionnaire_versions.id'), nullable=True),
        sa.Column('title', sa.String(200), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('triage_case_id', sa.String(36), sa.ForeignKey('triage_cases.id'), nullable=True),
        ...
        sa.Column('last_downloaded_by', sa.String(36), nullable=True),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.func.now()),
        sa.Column('updated_at', sa.DateTime(timezone=True), onupdate=sa.func.now()),
    )
    ...
    op.create_table(
        'llm_summaries',
        sa.Column('id', sa.String(36), primary_key=True),
        sa.Column('triage_case_id', sa.String(36), sa.ForeignKey('triage_cases.id'), nullable=False, index=True),
