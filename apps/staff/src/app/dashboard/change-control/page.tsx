    ...
    <div className={styles.layout}>
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.nav}>
          ...
          <Link href="/dashboard/change-control" className={styles.navItemActive}>Change Control</Link>
        </nav>
      </aside>
      ...
      <main className={styles.main}>
        <header className={styles.header}>
          ...
          <p className={styles.subtitle}>Manage ruleset approvals and questionnaire versions</p>
        </header>
        ...
        <div className={styles.content}>
          {loading ? (
            ...
            <>
              ...
              <div className={styles.section}>
                ...
                {rulesetHistory.length === 0 ? (
                  <p className={styles.emptyState}>No approval history</p>
                ) : (
            ...
            <div className={styles.section}>
              ...
              <p className={styles.emptyState}>Select a questionnaire to view version history</p>
            </div>
          )}
        </div>
